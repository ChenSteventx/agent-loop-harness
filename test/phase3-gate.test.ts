...
const gates = [
  ...
  [4, "legacy runs without manifests are not Exact Replay", "test/evaluation-replay.test.ts", "exact_replayability"],
  ...
  [16, "high and non-low risk never enter automatic Canary", "test/canary.test.ts", "assignment-medium"],
